...
RowLayout {
  ...
  ComboBox {
    ...
    background: Item {
      ...
      readonly property color bgColor: Color.mSurface
      ...
      Item {
        ...
        PowerlineTriangle { position: "left"; width: comboBg.pwSize; fillColor: comboBg.bgColor }
        Rectangle {
          anchors.left: parent.left; anchors.right: parent.right
          anchors.leftMargin: comboBg.pwSize; anchors.rightMargin: comboBg.pwSize
          height: parent.height; color: comboBg.bgColor
        }
        PowerlineTriangle { position: "right"; width: comboBg.pwSize; fillColor: comboBg.bgColor }
      }
      ...
      MouseArea {
        ...
        onEntered: { if (root.tooltip != "") TooltipService.show(root, root.tooltip) }
        onExited: { if (root.tooltip != "") TooltipService.hide() }
      }
    }
