...
ColumnLayout {
  ...
  readonly property color headerColor: root.expanded ? Color.mSecondary : Color.mPrimary
  ...
  Item {
    ...
    Rectangle {
      ...
      Behavior on color { enabled: root._userInteracted; ColorAnimation { duration: Style.animationNormal } }
      Behavior on border.color { enabled: root._userInteracted; ColorAnimation { duration: Style.animationNormal } }
    }
    ...
    Item {
      ...
      PowerlineTriangle { position: "left"; width: root.pwSize; fillColor: root.headerColor }
      Rectangle {
        anchors.left: parent.left; anchors.right: parent.right
        anchors.leftMargin: root.pwSize; anchors.rightMargin: root.pwSize
        height: parent.height; color: root.headerColor
        Behavior on color { enabled: root._userInteracted; ColorAnimation { duration: Style.animationNormal } }
      }
      PowerlineTriangle { position: "right"; width: root.pwSize; fillColor: root.headerColor }
    }
    ...
    MouseArea {
      ...
      Rectangle {
        ...
        radius: PowerlineConfig.enabled ? 0 : Style.iRadiusM
