  ...
  Control {
    ...
    background: Item {
      ...
      Item {
        ...
        PowerlineTriangle { position: "left"; width: frame.pwSize; fillColor: frame.bgColor }
        Rectangle {
          anchors.left: parent.left; anchors.right: parent.right
          anchors.leftMargin: frame.pwSize; anchors.rightMargin: frame.pwSize
          height: parent.height; color: frame.bgColor
        }
        PowerlineTriangle { position: "right"; width: frame.pwSize; fillColor: frame.bgColor }
      }
    }
