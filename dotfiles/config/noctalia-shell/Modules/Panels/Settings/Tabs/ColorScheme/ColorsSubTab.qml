    ...
    GridLayout {
      ...
      Repeater {
        ...
        Item {
          ...
          NPowerlineWrapper {
            anchors.fill: parent
            fillColor: root.getSchemeColor(schemeItem.schemeName, "mSurface")
            triangleSize: PowerlineConfig.sizeLarge
            border.width: Style.borderL
            border.color: {
              if ((Settings.data.colorSchemes.predefinedScheme === schemeItem.schemeName) && schemeItem.enabled)
                return Color.mSecondary;
          ...
          RowLayout {
            id: scheme
            anchors.fill: parent
            anchors.leftMargin: PowerlineConfig.enabled ? PowerlineConfig.sizeLarge + Style.marginS : Style.marginL
            anchors.rightMargin: PowerlineConfig.enabled ? PowerlineConfig.sizeLarge + Style.marginS : Style.marginL
            spacing: Style.marginS
