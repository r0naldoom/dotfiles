          ...
          Item {
            ...
            NListView {
              ...
              delegate: Item {
                ...
                property color itemColor: selected ? Color.mPrimary : (tabItem.hovering ? Color.mHover : "transparent")
                readonly property bool usePowerline: Settings.data.ui.powerlineStyle
                readonly property int pwSize: 8
                ...
                Rectangle {
                  anchors.fill: parent
                  visible: !tabItem.usePowerline
                  radius: Style.iRadiusS
                  color: tabItem.itemColor
                  Behavior on color {
                    enabled: !Color.isTransitioning
                ...
                Item {
                  ...
                  Canvas {
                    id: leftPw
                    width: tabItem.pwSize
                    height: parent.height
                    anchors.left: parent.left
                    onPaint: {
                      var ctx = getContext("2d")
                      ctx.reset()
                      ctx.fillStyle = tabItem.itemColor
                      ctx.beginPath()
                      ctx.moveTo(0, 0)
                      ctx.lineTo(width, 0)
                    ...
                    Connections {
                      target: tabItem
                      function onItemColorChanged() { leftPw.requestPaint() }
                    }
                  }
                  ...
                  Rectangle {
                    ...
                    anchors.leftMargin: tabItem.pwSize
                    anchors.rightMargin: tabItem.pwSize
                    height: parent.height
                    color: tabItem.itemColor
                    Behavior on color {
                      enabled: !Color.isTransitioning
                  ...
                  Canvas {
                    ...
                    Connections {
                      target: tabItem
                      function onItemColorChanged() { rightPw.requestPaint() }
                    }
                  }
                }
                ...
                RowLayout {
                  id: tabEntryRow
                  anchors.fill: parent
                  anchors.leftMargin: tabItem.usePowerline ? tabItem.pwSize + Style.marginS : Style.marginS
                  anchors.rightMargin: tabItem.usePowerline ? tabItem.pwSize + Style.marginS : Style.marginS
