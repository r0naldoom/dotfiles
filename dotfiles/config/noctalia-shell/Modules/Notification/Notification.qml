        ...
        Repeater {
          ...
          delegate: Item {
            ...
            Item {
              ...
              NPowerlineWrapper {
                anchors.fill: parent
                fillColor: Qt.alpha(Color.mSurface, Settings.data.notifications.backgroundOpacity || 1.0)
                triangleSize: PowerlineConfig.sizeLarge
              ...
              Rectangle {
                ...
                readonly property real progressInset: PowerlineConfig.enabled ? PowerlineConfig.sizeLarge : Style.radiusL
                readonly property real availableWidth: parent.width - (2 * progressInset)

                Rectangle {
                  id: progressBar
                  height: parent.height
                  x: parent.progressInset + (parent.availableWidth * (1 - model.progress)) / 2
            ...
            ColumnLayout {
              ...
              anchors.leftMargin: PowerlineConfig.enabled ? PowerlineConfig.sizeLarge + Style.marginM : Style.marginM
              anchors.rightMargin: PowerlineConfig.enabled ? PowerlineConfig.sizeLarge + Style.marginM : Style.marginM
